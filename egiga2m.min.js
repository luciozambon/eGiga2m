...
"javascript: refreshExportLink();"),document.getElementById("multiParam").value=plotURL+"?"+r+h+""+m+t}
...
1]={title:{text:"Y"+e},opposite:2==t&&2==e},n[e-1]&&(l.yAxis[e-1].min=n[e-1]),q[e-1]&&(l.yAxis[e-1].max=q[e-1]),u[e-1]&&"1"==u[e-1]&&(l.yAxis[e-1].type="logarithmic"),l.yAxis[e-1].labels={formatter:function(){return this.value}},m[e-1]&&(l.yAxis[e-1].categories=m[e-1]);if("undefined"!==typeof window.$_GET.yLabel)for(m=window.$_GET.yLabel.split(";"),e=1;e<=t;e++)l.yAxis[e-1].title={text:"undefined"!==typeof m[e-1]?m[e-1]:m[0]};Highcharts.setOptions({global:{useUTC:!1}});myPlot=new Highcharts.Chart(l,
