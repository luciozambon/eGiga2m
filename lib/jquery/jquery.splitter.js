...
(function(factory, undefined) {
    ...
    $.fn.split = function(options) {
                        ...
                        if (n === undefined) {
                            ...
                            for (var i = 0; i < position.length; ++i) {
                                ...
                                if (settings.invisible) {
									...
									// console.log('splitter: ', pos_name, (pw + sw_sum) / dim_px * 100);
                                } else {
        ...
        self.on('splitter.resize', function(e) {
			...
			$('#tree')[0].children[0].style.width = pos+'px';
			var configSize = pos-0;
			document.getElementById('plotContainer').style.left = (configSize+20) + 'px';
			document.getElementById('plotContainer').style.width = (window.innerWidth-configSize-37) + 'px';
			document.getElementById('placeholder').style.width = (window.innerWidth-configSize-44) + 'px';
			//console.log('splitter.resize', pos );
        });
        ...
        self.position(pos, true);
		// console.log('jquery.splitter.js 0');
		var configSize = document.location.search.indexOf('config_size=')==-1? 280: document.location.search.split('config_size=')[1].split('&')[0]-0;
		document.getElementById('mainContainer').style.height = (window.innerHeight-100 ) + 'px';
		document.getElementsByClassName('vsplitter')[0].style.left = configSize+'px';
		document.getElementById('plotContainer').style.left = (configSize+20)+'px';
		document.getElementById('plotContainer').style.width = (window.innerWidth-configSize-37) + 'px';
		document.getElementById('placeholder').style.width = (window.innerWidth-configSize-44) + 'px';
		document.getElementById('plotContainer').style.height = (window.innerHeight-100 ) + 'px';

		document.getElementById('configContainer').style.height = (window.innerHeight-70) + 'px';
		document.getElementById('configContainer').style.width = configSize + 'px';
		document.getElementById('startstopconfig').style.height = '60px';
 		document.getElementById('treeconfig').style.top = "65px";
		document.getElementById('treeconfig').style.height = (window.innerHeight-200)+'px';
		$('#buttconfig').css('margin-left',10);
		// console.log($('#tree')[0].children[0]);
		// $('#tree')[0].children[0].style.width = configSize+'px';
       /*
